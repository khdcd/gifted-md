...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~pWNUADIb#yVIHiMI9jBr9CEM3LqOyd62Wdv-21HNyNHhs95HcqpI", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
SUDO_NUMBERS: process.env.SUDO_NUMBERS || "94786936834", //Add multiple Numbers with Country Codes without (+) Separated by Comma...
...
STATUS_REPLY_MSG: process.env.STATUS_REPLY_MSG || "✅️ Status Viewed by DCD{KNIGHT}!", // // Input Yours custom...
MODE: process.env.MODE || "public", // Put private or public or inbox or groups
OWNER_NUMBER: process.env.OWNER_NUMBER || "94786936834", // Only 1 owner Number Here, others Add to sudo numbers...
OWNER_NAME: process.env.OWNER_NAME || "𝐆𝐈𝐅𝐓𝐄𝐃 𝐓𝐄𝐂𝐇{DCD}", // Input Yours custom...(Maintain font for Flow)
